...
public class Main {
    public static void main(String[] args) throws inputException,
        ...
        new Okladka("Okladki/o1.jpg",ksiazkaList.get(random.nextInt(ksiazkaList.size())));
        new Okladka("Okladki/o2.jpg",ksiazkaList.get(random.nextInt(ksiazkaList.size())));
        new Okladka("Okladki/o3.jpg",ksiazkaList.get(random.nextInt(ksiazkaList.size())));
        new Okladka("Okladki/o4.jpg",ksiazkaList.get(random.nextInt(ksiazkaList.size())));
        new Okladka("Okladki/o5.jpg",ksiazkaList.get(random.nextInt(ksiazkaList.size())));
